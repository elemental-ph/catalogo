        ...
        {galeria.length > 1 && (
          <div className="absolute inset-0 z-20 flex items-center justify-between p-4 pointer-events-none">
            <button
              ...
              className="pointer-events-auto cursor-pointer flex items-center justify-center w-10 h-10 rounded-full bg-[#505050] hover:bg-black/60 text-white backdrop-blur-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-white/50"
            >
              <svg className="w-5 h-5 stroke-current" fill="none" viewBox="0 0 24 24">
                <path strokeLinecap="square" strokeLinejoin="round" strokeWidth="3" d="M15 19l-7-7 7-7" />
              </svg>
            </button>
            ...
            >
              <svg className="w-5 h-5 stroke-current" fill="none" viewBox="0 0 24 24">
                <path strokeLinecap="square" strokeLinejoin="round" strokeWidth="3" d="M9 5l7 7-7 7" />
              </svg>
            </button>
          </div>
        )}
