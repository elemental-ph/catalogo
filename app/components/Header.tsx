...
const Header: React.FC = () => {
  ...
  return (
    <header className="fixed md:bg-transparent bg-[#505050] z-50 pointer-events-none transition-all w-full px-6 pb-5 md:px-8">
  <div className="flex  items-center justify-center py-6 md:h-[110px] md:py-0 decoration-3 underline-offset-6 transition duration-300 hover:underline">
    ...
    <div className="md:relative md:right-65 md:top-7 text-2xl md:h-fit md:leading-none flex font-bold justify-center">
      contacte a
    </div>
